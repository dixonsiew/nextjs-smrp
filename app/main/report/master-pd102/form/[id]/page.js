...
import ReportService from '../../../../../api/report/pd102';
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-4">
                      <input type="text" placeholder="GRAVIDA"
                  ...
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-4">
                      <input type="text" placeholder="PARITY"
                  ...
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-4">
                      <input type="text" placeholder="GESTATION PERIOD"
                  ...
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-4">
                      <input type="text" placeholder="ISMOTHERALIVE TIME"
                  ...
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-4">
                      <input type="text" placeholder="REFANTENATALCARECODE"
                  ...
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-4">
                      <input type="text" placeholder="LABOUR METHOD"
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-4">
                      <input type="text" placeholder="RESULT_OF_BIRTH"
                  ...
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-10">
                      <div className="input-group">
                        <input type="text" className="form-control" {...register('DELIVERY_TYPE')} />
                  ...
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-10">
                      <div className="input-group">
                        <input type="text" className="form-control" {...register('CHILD_SEX')} />
