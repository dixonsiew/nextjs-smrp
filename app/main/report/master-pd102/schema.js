...
export const schema = yup.object({
  ...
  PERSON_HEIGHT: yup.string().optional(),
  PERSON_WEIGHT: yup.string().optional(),
  ...
  GRAVIDA: yup.string().optional(),
  PARITY: yup.string().optional(),
  GESTATION_PERIOD: yup.string().optional(),
  ISMOTHERALIVE: yup.string().optional(),
  REFANTENATALCARECODE: yup.string().optional(),
  LABOUR_METHOD: yup.string().optional(),

  DELIVERY_DATE: yup.string().optional(),
  RESULT_OF_BIRTH: yup.string().optional(),
  DELIVERY_TYPE: yup.string().optional(),
  CHILD_SEX: yup.string().optional(),
