...
import ReportService from '../../../../api/report/pd105';
import AppConstant from '../../../../../app/constants';
import Helper from '../../../../../utils/helper';
import download from 'downloadjs';

const page = () => {
  const uiState = 'report.master-pd105.master-pd105-listing';
  const title = 'PD105';
  const placeholderdateFrom = 'Death From Date';
  const placeholderdateTo = 'Death To Date';
  ...
  const goto = (path) => {
    saveUIState();
    router.push(`/main/report/master-pd105/${path}`);
  }
