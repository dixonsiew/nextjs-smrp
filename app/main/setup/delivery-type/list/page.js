...
const page = () => {
  const uiState = 'setup.delivery-type.delivery-type-listing';
  ...
  const load = async () => {
    ...
    try {
      const response = await DeliveryTypeService.list(uiData.page, pageSize, uiData.sort, uiData.sortDir);
      setUiData(prev => ({
        ...prev,
        loading: false,
        list: response.data,
  ...
  const onSearch = async (e) => {
    ...
    try {
      const response = await DeliveryTypeService.search(uiData.page, pageSize, uiData.sort, uiData.sortDir, e);
      setUiData(prev => ({
        ...prev,
        loading: false,
        list: response.data,
